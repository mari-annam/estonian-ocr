...
# generate corrected text with new parameters (temperature, top_p, top_k)
...
"""
    ...
    outputs = fixer_model.generate(**inputs, max_new_tokens=max_new_tokens, temperature=0.8, top_p=0.95, top_k=50)
